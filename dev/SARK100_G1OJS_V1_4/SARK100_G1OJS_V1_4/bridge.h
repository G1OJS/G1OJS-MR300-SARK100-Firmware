...
//  Prototypes
//-----------------------------------------------------------------------------
extern void MeasureBrgRts(void);
extern WORD wRead_ADC_DDSON (BYTE VxPort);
extern WORD wRead_ADC_DDSUNCHANGED (BYTE VxPort);
extern WORD wDivide(WORD num, WORD denom);
