...
export LoadConfig_sark100_g1ojs_v1_4
export _LoadConfig_sark100_g1ojs_v1_4
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_sark100_g1ojs_v1_4
	lcall	LoadConfigTBL_sark100_g1ojs_v1_4_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration sark100_g1ojs_v1_4
;
;    Load configuration registers for sark100_g1ojs_v1_4.
...
;               CUR_PP
;
_LoadConfig_sark100_g1ojs_v1_4:
 LoadConfig_sark100_g1ojs_v1_4:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_sark100_g1ojs_v1_4_Bank0
    mov     X, <LoadConfigTBL_sark100_g1ojs_v1_4_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_sark100_g1ojs_v1_4_Bank1
    mov     X, <LoadConfigTBL_sark100_g1ojs_v1_4_Bank1
